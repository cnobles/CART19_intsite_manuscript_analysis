...
buster <- parallel::makeCluster(numCores, outfile = file.path(outputDir, "gen_cluster_call.out")) 
...
#  ,
#  from_counts_to_density = from_counts_to_density, refGenes = refGenes, 
#  CpG_islands = CpG_islands, DNaseI = DNaseI,
#  window_size_refSeq = window_size_refSeq, window_size_GC = window_size_GC, 
#  window_size_CpG_counts = window_size_CpG_counts,
#  window_size_CpG_density = window_size_CpG_density, 
#  window_size_DNaseI = window_size_DNaseI, genome_sequence = genome_sequence
))))
...
buster <- parallel::makeCluster(numCores, outfile = file.path(outputDir, "epi_cluster_call.out")) 
